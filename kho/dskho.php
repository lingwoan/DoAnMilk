<?php
    require_once(realpath(dirname(__FILE__) . '/../kho/ketnoispkho.php'));
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main">
    <div class="menu">
      ...
      <div class="menu-item">
        ...
        <a href="./../kho/dskho.php">Sản Phẩm</a>
          ...
          <?php 
            ...
            ?>
              <div class="row item">
                ...
                <div class="col">
                  <a href="./suaspkho.php?page_layout=dssp&id=<?php echo $row['masp']?>">Sửa</a>
                </div>
              </div>
              <?php } ?>
    </div>
    <a class="btn btn-primary" href="./themspkho.php">Thêm Mới</a>
    </div>
    </div>
</div>
