<?php
require_once(realpath(dirname(__FILE__) . '/../nhansu/ketnoiuser.php'));
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="main">
    <div class="menu">
      ...
      <a href="./index.html">Trang Chủ</a>
        <a href="./dsuser.php">Người Dùng</a>
        ...
        <div class="container py-5">
          ...
          ?>
            <div class="row item">
              ...
              <div class="col">
                <a href="./xoauser.php?page_layout=dsuser&id=<?php echo $row['maus'] ?>">Xoá</a>
              </div>
              <div class="col">
                <a href="./suauser.php?page_layout=dsuser&id=<?php echo $row['maus'] ?>">Sửa</a>
              </div>
            </div>
          <?php } ?>
        </div>
        <a class="btn btn-primary" href="./themuser.php">Thêm Mới</a>
      </div>
    </div>
  </div>
</body>
